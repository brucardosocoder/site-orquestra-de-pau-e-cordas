...
var carouselSlides = document.querySelectorAll(".thumbnail-container");
...
// Adicionar evento de clique a cada miniatura do carousel
...
// Adicionar evento de clique no botão de fechar em cada modal
...
// Adicionar evento de clique fora da modal para fechar
...
// Função para carregar miniaturas dos vídeos do YouTube
function carregarMiniatura(videoId, index) {
    var img = document.querySelectorAll(".carousel-slide")[index];
    var thumbnailUrl = `https://img.youtube.com/vi/${videoId}/hqdefault.jpg`;
    img.src = thumbnailUrl;
}

// Carregar miniaturas para cada imagem do carousel
carouselSlides.forEach(function (slide, index) {
    var videoId = slide.getAttribute("data-video-id");
    carregarMiniatura(videoId, index);
});

// Função para pausar o vídeo quando a modal é fechada
function pausarVideo(index) {
    var iframe = modals[index].querySelector("iframe");
    var videoSrc = iframe.src;
    iframe.src = videoSrc; // Isso redefine a origem do vídeo, pausando a reprodução
}

// Função para fechar a modal
function fecharModal(index) {
    pausarVideo(index); // Pausar o vídeo antes de fechar a modal
    modals[index].style.display = "none";
}
